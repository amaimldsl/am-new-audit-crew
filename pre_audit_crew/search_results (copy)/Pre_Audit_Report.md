### Comprehensive Report on Basel Pillar II for Banks (2025)
...
##### 5. **Systemic Risk Buffer**
   ...
   - **Stakeholders**: 
     - **Regulatory Authorities**: ECB, national regulators, CBUAE.
     - **Banks**: Systemically important banks in the EU and UAE.
     - **Investors**: Equity and debt investors.
...
The PRCT matrix for each sub-process is compiled below:

| Process Category          | Process Name                          | Risk Description                                                                 | Risk Rating | Control Measures                                                                 | Test Steps                                                                 |
|---------------------------|---------------------------------------|----------------------------------------------------------------------------------|-------------|----------------------------------------------------------------------------------|----------------------------------------------------------------------------|
| Capital Adequacy Assessment | Supervisory Review and Evaluation Process (SREP) | Inadequate capital to cover potential losses from adverse scenarios               | High        | Implementation of a robust ICAAP and adherence to the P2R set by regulators      | 1. Review the bank's ICAAP documentation. 2. Verify the calculation of the P2R. 3. Assess the bank's compliance with the capital conservation buffer and other buffers. 4. Conduct stress testing to ensure capital adequacy under adverse scenarios. |
| Capital Adequacy Assessment | Pillar 2 Capital Requirement (P2R)   | Insufficient capital to cover bank-specific risks                                 | High        | Regular review and adjustment of the P2R by supervisory authorities              | 1. Verify the calculation of the P2R. 2. Assess the bank's compliance with the P2R. 3. Conduct stress testing to ensure capital adequacy under adverse scenarios. |
| Capital Buffers            | Capital Conservation Buffer           | Insufficient capital buffer to absorb losses during financial stress              | Medium      | Regular monitoring and adjustment of the capital conservation buffer             | 1. Verify the calculation of the capital conservation buffer. 2. Assess the bank's compliance with the buffer requirements. 3. Conduct stress testing to ensure the buffer is sufficient under adverse scenarios. |
| Capital Buffers            | Countercyclical Capital Buffer        | Insufficient capital buffer to mitigate the risk of a financial downturn          | Medium      | Regular monitoring and adjustment of the countercyclical capital buffer          | 1. Verify the calculation of the countercyclical capital buffer. 2. Assess the bank's compliance with the buffer requirements. 3. Conduct stress testing to ensure the buffer is sufficient under adverse scenarios. |
| Capital Buffers            | Systemic Risk Buffer                  | Insufficient capital buffer to mitigate systemic risk                              | High        | Regular monitoring and adjustment of the systemic risk buffer                    | 1. Verify the calculation of the systemic risk buffer. 2. Assess the bank's compliance with the buffer requirements. 3. Conduct stress testing to ensure the buffer is sufficient under adverse scenarios. |
